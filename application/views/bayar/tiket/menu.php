		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav mr-auto nav nav-pills navbar-expand-lg">
				<li class="nav-item active">
					<a href="<?php echo site_url($controller . '/page/' . $request); ?>"
					   class="nav-link <?php echo ($tabs == 'bayar') ? 'active' : ''; ?>"><i
								class="fa fa-bank"></i> Bill
						<span class="bg-light badge badge-pill badge-primary ml-auto"><?= $tot; ?></span>
					</a>

				</li>
				<li class="nav-item active">
					<a href="<?php echo site_url($controller . '/report/' . $request); ?>"
