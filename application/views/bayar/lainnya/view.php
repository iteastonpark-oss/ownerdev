...
-->
				<div class="col-md-4">
					<div class="form-group">
						...
						<?= $this->dropdown_model->getDropdownTagihanLain('id_tag', $id_tag, 'class="form-control satu" onchange="this.form.submit()"'); ?>
	...
	<div class="table-responsive">
		<table class="table table-datatables table-hover dt-responsive nowrap table-sm" width="100%" cellspacing="0">
			<thead>
				<tr class="active">
					<?php
					foreach ($field as $tr) {
...
<script type="text/javascript">
	...
	$(document).on("click", '.bayar', function(e) {
		...
		$('#form')[0].reset(); // reset form on modals
		var url = "<?php echo site_url($controller . '/form_bayar/') ?>" + tipe;
