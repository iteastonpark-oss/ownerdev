...
<div class="row">
	<div class="col-md-6">
		...
		<div class="form-group">
			...
			<?= $this->dropdown_model->getDropdownUnitBast('id_bast',
					($submit == 'edit') ? $b->id_bast : '', 'class="form-control satu"'); ?>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			<?php
			echo $this->dropdown_model->getDropdownTagLainnya('id_tag', ($submit == 'edit') ? $b->id_tag : '6000',
					'class="form-control"
							id="input_tagihan"');
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<input type="text" id="input_harga"
				   ...
				   value="<?= ($submit == 'edit') ? $b->harga_dasar : '0' ?>"
				   required>
		</div>
	</div>
	<div class="col-md-3">
		<div class="form-group">
			<label>Admin</label>
			<input type="text" id="input_admin" name="admin"
				   class="form-control  form-control-sm getNumber" value="<?= ($submit == 'edit') ? $b->admin : '0' ?>"
				   required>
		</div>
	</div>
	<div class="col-md-3">
		<div class="form-group">
			<label>TAX</label>
			<input type="text" id="input_tax" name="tax"
				   class="form-control  form-control-sm getNumber" value="<?= ($submit == 'edit') ? $b->tax : '0' ?>"
				   required>
		</div>
	</div>
	<div class="col-md-3">
