	...
	<div class="card-body" style="font-size: 14pt; width: 100%; font-family:'Courier New', Courier, monospace">
		<table class="table table-sm table-borderless font-weight-bold">
			<tr>
				...
				<td></td>
				<th class="text-right"><span class="font-weight-bold"
											 style="font-size: 12pt">No. <?php echo $bayar->kwt; ?></span>
				</th>
			</tr>
			<tr>
				...
				<td class="text-right"><span
							class="text-right"
							style="font-size: 12pt"> <?php echo $this->apl->tgl_format(date('j M Y'), 5); ?></span>
				</td>
			</tr>
		</table>
		<br>
		<table class="ml-4 table-borderless font-weight-bold"  >
		<tr>
				<th><span style="font-size: 12pt">Sudah Terima dari</span></th>
				<th>
					<span style="font-size: 12pt">: <?php echo $unit; ?> </span></th>
			</tr>
