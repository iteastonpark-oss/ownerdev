...
<table class="small table-borderless table-sm ">
	<tr>
		...
		<td style="width: 40%">: <?php echo $p->nama; ?></td>
	...
	<tr>
		...
		<td>Alamat</td>
		<td>: <?php echo $bast->alamat_surat . " " . $bast->kota_surat; ?></td>
	...
	<tr>
		...
		<!--
		<td>Tlp./Email</td>
		<td>: <?php echo $bast->hp_surat . " - " . $bast->tlp_surat . " / " . $bast->email_surat; ?></td>
		-->
		<td>Tlp.</td>
		<td>: <?php echo $bast->hp_surat . " - " . $bast->tlp_surat; ?></td>
...
<table class="table-striped text-sm small" id="table_style">
	...
	<tr>
		...
		<td>Rp.<span class="pull-right"><?php echo $this->apl->number_format($over_payment, 1); ?>
	...
	<tr>
		...
		<td>Rp. <b><span class="pull-right">
				...
				$total_tagihan = $tagihan_sebelumnya + $denda + $total_berjalan - $over_payment;
...
<table>
	<tr>
		...
		<td><h4 class="pull-left"><i>
					<?php echo $this->apl->terbilang($total_tagihan); ?> Rupiah</i></h4></td>
	</tr>
</table>

<span><b><small>Cara Pembayaran :</small> </b></span>
<!--
<p><b>Pembayaran Dapat di transfer ke Rek. sebagai berikut :</b></p>
-->
<p><b>Pembayaran Dapat di transfer ke Rek. Virtual Account berikut :</b></p>
<table style="width:60%;" class="table table-sm small table-borderless">
	<tr>
		<?php
		foreach ($va as $vir) {
			?>
