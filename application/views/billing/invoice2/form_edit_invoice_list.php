	...
	<tr>
		...
		<td style="width: 30%">
			<input type="checkbox" class="check_no_invoice"
				   name="check_no_invoice" value="1"> Ceklis Jika Berbeda No Invoice
			<script>
				var check_baru;
				$('.no_invoice').hide();
...
<h6 class="heading-small text-muted mb-2 mt-2">Tagihan Periode</h6>
<input type="checkbox" class="update_tagihan_periode ml-2"
	   name="update_tagihan_periode" value="1"> Ceklis Jika Update Tagihan Periode
<script>
	var check_periode;
...
<div class="form-input-periode">
	...
	<h6 class="heading-small text-muted mb-2 mt-2">Tagihan Administrasi</h6>
...
<h6 class="heading-small text-muted mb-2 mt-2">Piutang</h6>
