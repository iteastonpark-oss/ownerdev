		...
		<tr>
			...
			<td style="line-height: 8px; font-size: 6pt">
				<ul style="padding-left: 10px">
					...
					<li>Biaya pengiriman Rp. 10.000 akan dibebankan kepada masing-masing pemilik unit untuk setiap pengiriman invoice, kwitansi, dll kecuali melalui email</li>
					<li>Pemutusan utilitas akan dilakukan untuk setiap unit yang belum melakukan pembayaran setelah jatuh tempo</li>
