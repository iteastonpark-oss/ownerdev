					...
					<div class="container-fluid">
						...
						<div id="page-input">
							...
							<div class="form-group">
								<label for="" class="control-label">Kode Unit</label>
								<input type="text" name="kode" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="" class="control-label">Lantai</label>
								<?= $this->dropdown_model->getDropdownLantaiUnit('lantai', '', 'class="form-control" required'); ?>
							</div>
							<div class="form-group">
								<label for="" class="control-label">Tipe Unit</label>
								<?= $this->dropdown_model->getDropdownTipeUnit('tipe', '', 'class="form-control" required'); ?>
							</div>
							<div class="form-group">
								<label for="" class="control-label">Tower Unit</label>
								<?= $this->dropdown_model->getDropdownTowerUnit('tower', '', 'class="form-control" required'); ?>
							</div>
							<div class="form-group">
								<label for="" class="control-label">No. Kamar</label>
								<input type="text" name="nomor" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="" class="control-label">Luas Unit</label>
								<input type="text" name="luas" class="form-control" required>
							</div>
							<div class="form-group">
								<label for="" class="control-label">KWH Listrik</label>
								<input type="text" name="listrik" class="form-control" required>
							</div>

							<div class="form-group">
								<label for="" class="control-label">Group Unit</label>
								<?= $this->dropdown_model->getDropdownGroupUnit('id_group', '', 'class="form-control" required'); ?>
							</div>
